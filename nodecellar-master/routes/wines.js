...
exports.findById = function(req, res) {
    ...
    db.collection('wines', function(err, collection) {
        collection.findOne({'_id':new BSON.ObjectID(id)}, function(err, item) {
            console.log('---find wine: ' + item);
            if(err) res.status(500).send(err);
            else if(item == null) res.status(404).send({});
            else res.send(item);
        });
    });
};
...
var populateDB = function() {
    ...
    var wines = [
    {
        _id : new BSON.ObjectID("53d6baaf109915b214000001"),
    ...
    {
        _id : new BSON.ObjectID("53d6baaf109915b214000002"),
    ...
    {
        _id : new BSON.ObjectID("53d6baaf109915b214000003"),
